    ...
    <Card className="group overflow-hidden border-none shadow-xl rounded-[3rem] bg-white text-center hover:shadow-2xl transition-all duration-500 hover:-translate-y-4">
      <div className="relative h-80 overflow-hidden">
        ...
        <div className="absolute top-6 right-6 flex flex-col gap-3">
           <Badge className="bg-white/95 backdrop-blur-md text-slate-900 font-black px-6 py-2.5 rounded-full border-none shadow-xl text-[10px] uppercase tracking-widest">
             {chalet.city}
           </Badge>
      ...
      <CardContent className="p-8 space-y-8">
        <div className="grid grid-cols-2 gap-6">
          <div className="bg-slate-50 p-4 rounded-3xl space-y-1">
            <p className="text-slate-500 text-[10px] font-black uppercase tracking-widest">أيام الأسبوع</p>
          ...
          <div className="bg-primary/5 p-4 rounded-3xl space-y-1 border border-primary/10">
            <p className="text-primary/70 text-[10px] font-black uppercase tracking-widest">الويك إند</p>
        ...
        <button 
          ...
          className="w-full flex items-center gap-4 justify-center py-6 bg-slate-950 rounded-[2rem] text-white hover:bg-primary transition-all duration-500 font-black text-lg shadow-xl shadow-slate-900/10 group-hover:shadow-primary/30"
        >
