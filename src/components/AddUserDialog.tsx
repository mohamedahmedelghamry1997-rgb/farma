...
import { UserPlus, Shield, Briefcase, ClipboardCheck, Mail, Phone, Home } from "lucide-react"
      ...
      <DialogContent className="rounded-[2.5rem] border-none text-right max-w-xl">
        ...
        <div className="space-y-6 py-4">
           <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <Label className="font-bold text-slate-600 flex items-center gap-2 justify-end text-xs">البريد الإلكتروني <Mail className="h-3.3" /></Label>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label className="font-bold text-slate-600 flex items-center gap-2 justify-end text-xs">رقم الهاتف <Phone className="h-3.3" /></Label>
           ...
           <div className="space-y-3">
              <Label className="font-bold text-slate-600 flex items-center gap-2 justify-end text-xs">تعيين الوحدات (اختياري) <Home className="h-3.3" /></Label>
        ...
        <DialogFooter className="flex flex-row-reverse gap-3 pb-2">
           <Button className="flex-1 rounded-2xl h-14 font-black bg-primary text-white" onClick={handleAdd} disabled={!name || !email}>
